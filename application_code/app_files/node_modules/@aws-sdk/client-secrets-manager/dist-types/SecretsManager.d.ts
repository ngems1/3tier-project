...
export interface SecretsManager {
    ...
    batchGetSecretValue(args: BatchGetSecretValueCommandInput, options?: SecretsManagerRequestOptions): Promise<BatchGetSecretValueCommandOutput>;
    batchGetSecretValue(args: BatchGetSecretValueCommandInput, cb: (err: any, data?: BatchGetSecretValueCommandOutput) => void): void;
    batchGetSecretValue(args: BatchGetSecretValueCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: BatchGetSecretValueCommandOutput) => void): void;
    /**
     * @see {@link CancelRotateSecretCommand}
     */
    cancelRotateSecret(args: CancelRotateSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<CancelRotateSecretCommandOutput>;
    cancelRotateSecret(args: CancelRotateSecretCommandInput, cb: (err: any, data?: CancelRotateSecretCommandOutput) => void): void;
    cancelRotateSecret(args: CancelRotateSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: CancelRotateSecretCommandOutput) => void): void;
    /**
     * @see {@link CreateSecretCommand}
     */
    createSecret(args: CreateSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<CreateSecretCommandOutput>;
    createSecret(args: CreateSecretCommandInput, cb: (err: any, data?: CreateSecretCommandOutput) => void): void;
    createSecret(args: CreateSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: CreateSecretCommandOutput) => void): void;
    /**
     * @see {@link DeleteResourcePolicyCommand}
     */
    deleteResourcePolicy(args: DeleteResourcePolicyCommandInput, options?: SecretsManagerRequestOptions): Promise<DeleteResourcePolicyCommandOutput>;
    deleteResourcePolicy(args: DeleteResourcePolicyCommandInput, cb: (err: any, data?: DeleteResourcePolicyCommandOutput) => void): void;
    deleteResourcePolicy(args: DeleteResourcePolicyCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: DeleteResourcePolicyCommandOutput) => void): void;
    /**
     * @see {@link DeleteSecretCommand}
     */
    deleteSecret(args: DeleteSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<DeleteSecretCommandOutput>;
    deleteSecret(args: DeleteSecretCommandInput, cb: (err: any, data?: DeleteSecretCommandOutput) => void): void;
    deleteSecret(args: DeleteSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: DeleteSecretCommandOutput) => void): void;
    /**
     * @see {@link DescribeSecretCommand}
     */
    describeSecret(args: DescribeSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<DescribeSecretCommandOutput>;
    describeSecret(args: DescribeSecretCommandInput, cb: (err: any, data?: DescribeSecretCommandOutput) => void): void;
    describeSecret(args: DescribeSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: DescribeSecretCommandOutput) => void): void;
    /**
     * @see {@link GetRandomPasswordCommand}
     */
    getRandomPassword(): Promise<GetRandomPasswordCommandOutput>;
    getRandomPassword(args: GetRandomPasswordCommandInput, options?: SecretsManagerRequestOptions): Promise<GetRandomPasswordCommandOutput>;
    getRandomPassword(args: GetRandomPasswordCommandInput, cb: (err: any, data?: GetRandomPasswordCommandOutput) => void): void;
    getRandomPassword(args: GetRandomPasswordCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: GetRandomPasswordCommandOutput) => void): void;
    /**
     * @see {@link GetResourcePolicyCommand}
     */
    getResourcePolicy(args: GetResourcePolicyCommandInput, options?: SecretsManagerRequestOptions): Promise<GetResourcePolicyCommandOutput>;
    getResourcePolicy(args: GetResourcePolicyCommandInput, cb: (err: any, data?: GetResourcePolicyCommandOutput) => void): void;
    getResourcePolicy(args: GetResourcePolicyCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: GetResourcePolicyCommandOutput) => void): void;
    /**
     * @see {@link GetSecretValueCommand}
     */
    getSecretValue(args: GetSecretValueCommandInput, options?: SecretsManagerRequestOptions): Promise<GetSecretValueCommandOutput>;
    getSecretValue(args: GetSecretValueCommandInput, cb: (err: any, data?: GetSecretValueCommandOutput) => void): void;
    getSecretValue(args: GetSecretValueCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: GetSecretValueCommandOutput) => void): void;
    /**
     * @see {@link ListSecretsCommand}
     */
    listSecrets(): Promise<ListSecretsCommandOutput>;
    listSecrets(args: ListSecretsCommandInput, options?: SecretsManagerRequestOptions): Promise<ListSecretsCommandOutput>;
    listSecrets(args: ListSecretsCommandInput, cb: (err: any, data?: ListSecretsCommandOutput) => void): void;
    listSecrets(args: ListSecretsCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: ListSecretsCommandOutput) => void): void;
    /**
     * @see {@link ListSecretVersionIdsCommand}
     */
    listSecretVersionIds(args: ListSecretVersionIdsCommandInput, options?: SecretsManagerRequestOptions): Promise<ListSecretVersionIdsCommandOutput>;
    listSecretVersionIds(args: ListSecretVersionIdsCommandInput, cb: (err: any, data?: ListSecretVersionIdsCommandOutput) => void): void;
    listSecretVersionIds(args: ListSecretVersionIdsCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: ListSecretVersionIdsCommandOutput) => void): void;
    /**
     * @see {@link PutResourcePolicyCommand}
     */
    putResourcePolicy(args: PutResourcePolicyCommandInput, options?: SecretsManagerRequestOptions): Promise<PutResourcePolicyCommandOutput>;
    putResourcePolicy(args: PutResourcePolicyCommandInput, cb: (err: any, data?: PutResourcePolicyCommandOutput) => void): void;
    putResourcePolicy(args: PutResourcePolicyCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: PutResourcePolicyCommandOutput) => void): void;
    /**
     * @see {@link PutSecretValueCommand}
     */
    putSecretValue(args: PutSecretValueCommandInput, options?: SecretsManagerRequestOptions): Promise<PutSecretValueCommandOutput>;
    putSecretValue(args: PutSecretValueCommandInput, cb: (err: any, data?: PutSecretValueCommandOutput) => void): void;
    putSecretValue(args: PutSecretValueCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: PutSecretValueCommandOutput) => void): void;
    /**
     * @see {@link RemoveRegionsFromReplicationCommand}
     */
    removeRegionsFromReplication(args: RemoveRegionsFromReplicationCommandInput, options?: SecretsManagerRequestOptions): Promise<RemoveRegionsFromReplicationCommandOutput>;
    ...
    removeRegionsFromReplication(args: RemoveRegionsFromReplicationCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: RemoveRegionsFromReplicationCommandOutput) => void): void;
    /**
     * @see {@link ReplicateSecretToRegionsCommand}
     */
    replicateSecretToRegions(args: ReplicateSecretToRegionsCommandInput, options?: SecretsManagerRequestOptions): Promise<ReplicateSecretToRegionsCommandOutput>;
    ...
    replicateSecretToRegions(args: ReplicateSecretToRegionsCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: ReplicateSecretToRegionsCommandOutput) => void): void;
    /**
     * @see {@link RestoreSecretCommand}
     */
    restoreSecret(args: RestoreSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<RestoreSecretCommandOutput>;
    restoreSecret(args: RestoreSecretCommandInput, cb: (err: any, data?: RestoreSecretCommandOutput) => void): void;
    restoreSecret(args: RestoreSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: RestoreSecretCommandOutput) => void): void;
    /**
     * @see {@link RotateSecretCommand}
     */
    rotateSecret(args: RotateSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<RotateSecretCommandOutput>;
    rotateSecret(args: RotateSecretCommandInput, cb: (err: any, data?: RotateSecretCommandOutput) => void): void;
    rotateSecret(args: RotateSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: RotateSecretCommandOutput) => void): void;
    /**
     * @see {@link StopReplicationToReplicaCommand}
     */
    stopReplicationToReplica(args: StopReplicationToReplicaCommandInput, options?: SecretsManagerRequestOptions): Promise<StopReplicationToReplicaCommandOutput>;
    ...
    stopReplicationToReplica(args: StopReplicationToReplicaCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: StopReplicationToReplicaCommandOutput) => void): void;
    /**
     * @see {@link TagResourceCommand}
     */
    tagResource(args: TagResourceCommandInput, options?: SecretsManagerRequestOptions): Promise<TagResourceCommandOutput>;
    tagResource(args: TagResourceCommandInput, cb: (err: any, data?: TagResourceCommandOutput) => void): void;
    tagResource(args: TagResourceCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: TagResourceCommandOutput) => void): void;
    /**
     * @see {@link UntagResourceCommand}
     */
    untagResource(args: UntagResourceCommandInput, options?: SecretsManagerRequestOptions): Promise<UntagResourceCommandOutput>;
    untagResource(args: UntagResourceCommandInput, cb: (err: any, data?: UntagResourceCommandOutput) => void): void;
    untagResource(args: UntagResourceCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: UntagResourceCommandOutput) => void): void;
    /**
     * @see {@link UpdateSecretCommand}
     */
    updateSecret(args: UpdateSecretCommandInput, options?: SecretsManagerRequestOptions): Promise<UpdateSecretCommandOutput>;
    updateSecret(args: UpdateSecretCommandInput, cb: (err: any, data?: UpdateSecretCommandOutput) => void): void;
    updateSecret(args: UpdateSecretCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: UpdateSecretCommandOutput) => void): void;
    /**
     * @see {@link UpdateSecretVersionStageCommand}
     */
    updateSecretVersionStage(args: UpdateSecretVersionStageCommandInput, options?: SecretsManagerRequestOptions): Promise<UpdateSecretVersionStageCommandOutput>;
    ...
    updateSecretVersionStage(args: UpdateSecretVersionStageCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: UpdateSecretVersionStageCommandOutput) => void): void;
    /**
     * @see {@link ValidateResourcePolicyCommand}
     */
    validateResourcePolicy(args: ValidateResourcePolicyCommandInput, options?: SecretsManagerRequestOptions): Promise<ValidateResourcePolicyCommandOutput>;
    ...
    validateResourcePolicy(args: ValidateResourcePolicyCommandInput, options: SecretsManagerRequestOptions, cb: (err: any, data?: ValidateResourcePolicyCommandOutput) => void): void;
    /**
     * @see {@link BatchGetSecretValueCommand}
